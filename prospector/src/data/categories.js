 ...
 * (b) earn enough to comfortably afford Launch Media ($750–$2,500/mo).
 *
...
export const CATEGORIES = [
  ...
  // ── Expansion set — more local trades & services with weak web + real budget ──
  { key: 'solar', label: 'Solar Installer', searchTerm: 'solar panel installation company', placesType: '', tier: 'premium', avgTicketUsd: 18000, affordability: 0.9, note: 'Very high-ticket, incentive-driven demand. Heavy online research; strong marketing appetite.' },
  { key: 'foundation-repair', label: 'Foundation Repair', searchTerm: 'foundation repair contractor', placesType: '', tier: 'premium', avgTicketUsd: 8000, affordability: 0.85, note: 'Urgent structural fixes, $5k–$20k jobs. Trust-driven; many operators have thin web.' },
  { key: 'window-installation', label: 'Window & Door Installation', searchTerm: 'window installation contractor', placesType: '', tier: 'high', avgTicketUsd: 8000, affordability: 0.85, note: 'Whole-home window replacements are big-ticket. Buyers compare online; dated sites common.' },
  { key: 'siding', label: 'Siding Contractor', searchTerm: 'siding contractor', placesType: '', tier: 'high', avgTicketUsd: 12000, affordability: 0.85, note: 'Exterior remodels $10k+. Storm/curb-appeal driven; weak-site operators lose big jobs.' },
  { key: 'gutters', label: 'Gutter Installation', searchTerm: 'gutter installation service', placesType: '', tier: 'high', avgTicketUsd: 2000, affordability: 0.8, note: 'Installs + guards, seasonal. Small crews often have no real website.' },
  { key: 'waterproofing', label: 'Basement Waterproofing', searchTerm: 'basement waterproofing contractor', placesType: '', tier: 'high', avgTicketUsd: 6000, affordability: 0.85, note: 'Urgent, high-ticket, insurance-adjacent. Ranking + reviews highly valuable.' },
  { key: 'flooring', label: 'Flooring Contractor', searchTerm: 'flooring contractor', placesType: '', tier: 'high', avgTicketUsd: 4000, affordability: 0.8, note: 'Hardwood/tile/LVP installs. Showroom-weak sites convert poorly.' },
  { key: 'cabinets', label: 'Cabinets & Countertops', searchTerm: 'kitchen cabinet and countertop installer', placesType: '', tier: 'high', avgTicketUsd: 6000, affordability: 0.8, note: 'Kitchen upgrades $5k–$15k. Portfolio-driven; many under-invest online.' },
  { key: 'masonry', label: 'Masonry & Brickwork', searchTerm: 'masonry contractor', placesType: '', tier: 'high', avgTicketUsd: 5000, affordability: 0.8, note: 'Brick/stone/pavers, referral-heavy with minimal digital presence.' },
  { key: 'deck-builder', label: 'Deck & Patio Builder', searchTerm: 'deck builder', placesType: '', tier: 'high', avgTicketUsd: 8000, affordability: 0.8, note: 'Outdoor living $8k+. Gallery-only or no sites; strong seasonal demand.' },
  { key: 'excavation', label: 'Excavation & Grading', searchTerm: 'excavation contractor', placesType: '', tier: 'high', avgTicketUsd: 6000, affordability: 0.8, note: 'Site work/demolition, big equipment overhead. Rarely marketed online.' },
  { key: 'septic', label: 'Septic Service', searchTerm: 'septic tank service', placesType: '', tier: 'high', avgTicketUsd: 3500, affordability: 0.8, note: 'Install/pump/repair, urgent. Rural operators with little to no web.' },
  { key: 'moving', label: 'Moving Company', searchTerm: 'moving company', placesType: 'moving_company', tier: 'high', avgTicketUsd: 1500, affordability: 0.75, note: 'High search intent, lead-driven. Compete with vans/brokers on visibility.' },
  { key: 'insulation', label: 'Insulation Contractor', searchTerm: 'insulation contractor', placesType: '', tier: 'mid', avgTicketUsd: 2500, affordability: 0.7, note: 'Spray-foam/attic jobs, energy-rebate driven. Thin web presence.' },
  { key: 'handyman', label: 'Handyman Service', searchTerm: 'handyman service', placesType: '', tier: 'mid', avgTicketUsd: 500, affordability: 0.6, note: 'Huge search volume, repeat customers. Most run no real site.' },
  { key: 'pressure-washing', label: 'Pressure Washing', searchTerm: 'pressure washing service', placesType: '', tier: 'mid', avgTicketUsd: 400, affordability: 0.6, note: 'Easy-sell, high-frequency. Solo operators, weak/no web, quick wins.' },
  { key: 'carpet-cleaning', label: 'Carpet Cleaning', searchTerm: 'carpet cleaning service', placesType: '', tier: 'mid', avgTicketUsd: 300, affordability: 0.6, note: 'Recurring residential/commercial. Compete with franchises on SEO.' },
  { key: 'cleaning', label: 'Cleaning / Janitorial', searchTerm: 'commercial cleaning service', placesType: '', tier: 'mid', avgTicketUsd: 800, affordability: 0.65, note: 'Recurring contracts = high LTV. Fragmented, many with no site.' },
  { key: 'irrigation', label: 'Sprinkler & Irrigation', searchTerm: 'sprinkler and irrigation service', placesType: '', tier: 'mid', avgTicketUsd: 2500, affordability: 0.7, note: 'Install + seasonal service, recurring. Weak web among small crews.' },
  { key: 'auto-detailing', label: 'Auto Detailing', searchTerm: 'auto detailing service', placesType: '', tier: 'mid', avgTicketUsd: 250, affordability: 0.6, note: 'Ceramic coating/details, upsell-heavy. Instagram-only "sites" common.' },
  { key: 'dermatologist', label: 'Dermatologist', searchTerm: 'dermatology clinic', placesType: 'doctor', tier: 'premium', avgTicketUsd: 500, affordability: 0.9, note: 'Cosmetic + medical, high LTV. Affluent patients research online.' },
  { key: 'plastic-surgeon', label: 'Plastic Surgeon', searchTerm: 'plastic surgery clinic', placesType: 'doctor', tier: 'premium', avgTicketUsd: 8000, affordability: 0.95, note: 'Elective, very high-ticket. Brand + before/after galleries are everything.' },
  { key: 'cosmetic-dentist', label: 'Cosmetic Dentist', searchTerm: 'cosmetic dentist', placesType: 'dentist', tier: 'premium', avgTicketUsd: 3000, affordability: 0.95, note: 'Veneers/implants, high margin. Aggressive on SEO and conversion.' },
  { key: 'physical-therapy', label: 'Physical Therapy', searchTerm: 'physical therapy clinic', placesType: 'physiotherapist', tier: 'high', avgTicketUsd: 2000, affordability: 0.8, note: 'Recurring visit plans, high LTV. Independents vs chains; sites often stale.' },
  { key: 'optometrist', label: 'Optometrist', searchTerm: 'optometrist', placesType: 'doctor', tier: 'high', avgTicketUsd: 400, affordability: 0.85, note: 'Exams + eyewear, repeat customers. Many practices under-market online.' },
  { key: 'real-estate', label: 'Real Estate Agency', searchTerm: 'real estate agency', placesType: 'real_estate_agency', tier: 'high', avgTicketUsd: 9000, affordability: 0.85, note: 'Commission-funded; brokers/teams spend heavily on lead gen and branding.' },
  { key: 'mortgage', label: 'Mortgage Broker', searchTerm: 'mortgage broker', placesType: '', tier: 'high', avgTicketUsd: 4000, affordability: 0.85, note: 'Commission per loan; lead-driven. Small shops with weak web abound.' },
